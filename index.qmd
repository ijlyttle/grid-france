...
The goal of this project is to execute and document a data pipeline for aspects of the French electrical grid.
...
Using GitHub Actions, these tables are updated daily.
